...
<body>
	<div class="container">
		<form action="edit" method="post" class="form">
			...
			<div class="text">Trenutni naziv lokacije</div>
			<div class="name">
				<input type="text" name="nazivLokacije"  required="required" class="name">
			</div>
			<div class="text">Novi naziv lokacije</div>
			<div class="name">
				<input type="text" name="noviNaziv"  required="required" class="name">
			</div>
			<div class="text">Novi opis lokacije</div>
			<div>
